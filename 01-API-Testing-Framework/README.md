# 📡 Chapter 1: API Testing Framework# 📡 API 測試框架



<div align="center">## 🎯 這個模組在做什麼？



![API Tests](https://img.shields.io/badge/tests-8%20passed-brightgreen)這裡測試**後端 API**，確保：

![Coverage](https://img.shields.io/badge/coverage-100%25-brightgreen)- ✅ API 能正確回應

![Python](https://img.shields.io/badge/Python-3.12-blue)- ✅ 回應速度夠快

![pytest](https://img.shields.io/badge/pytest-7.4-blue)- ✅ 回應的資料格式正確
...
- **目標 API**: [JSONPlaceholder](https://jsonplaceholder.typicode.com) - 免費的假資料 REST API```powershell

- **測試類型**: 功能測試、資料驗證、錯誤處理、效能測試npm install -g newman newman-reporter-htmlextra

- **測試案例**: 8 個核心測試案例```

- **執行時間**: < 3 秒完成所有測試

- **通過率**: 100% ✅### 步驟 2：安裝 Python 套件

```powershell

### 💼 面試展示重點cd 01-API-Testing-Framework/python-api-tests
...
1. 完整的測試框架 (不只是 Postman 點擊)```powershell

2. 資料驅動測試設計# 執行 Python API 測試

3. pytest fixtures 的優雅使用pytest tests/ -v --html=../reports/api-test-report.html

4. 100% 的測試覆蓋率

5. 專業的測試報告# 執行 Postman 測試
